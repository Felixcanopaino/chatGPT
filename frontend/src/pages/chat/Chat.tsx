                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Empieza a chatear</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Este chatbot está configurado para responder a tus preguntas</h2>
                            </Stack>
                        ) : (
